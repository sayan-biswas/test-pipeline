...
// clusterReconcilerControllerGenerator produces a file for setting up the reconciler
// with injection.
type clusterReconcilerControllerGenerator struct {
...
var _ generator.Generator = (*clusterReconcilerControllerGenerator)(nil)

func (g *clusterReconcilerControllerGenerator) Filter(c *generator.Context, t *types.Type) bool {
	// Only process the type for this generator.
	return t == g.typeToGenerate
}

func (g *clusterReconcilerControllerGenerator) Namers(c *generator.Context) namer.NameSystems {
	return namer.NameSystems{
		"raw": namer.NewRawNamer(g.outputPackage, g.imports),
	}
}

func (g *clusterReconcilerControllerGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterReconcilerControllerGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	sw.Do(clusterReconcilerControllerNewImpl, m)

	return sw.Error()
}

var clusterReconcilerControllerNewImpl = `
const (
