...
// clusterFakeInformerGenerator produces a file of listers for a given GroupVersion and
// type.
type clusterFakeInformerGenerator struct {
...
var _ generator.Generator = (*clusterFakeInformerGenerator)(nil)

func (g *clusterFakeInformerGenerator) Filter(c *generator.Context, t *types.Type) bool {
	// Only process the type for this informer generator.
	return t == g.typeToGenerate
}

func (g *clusterFakeInformerGenerator) Namers(c *generator.Context) namer.NameSystems {
...
func (g *clusterFakeInformerGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterFakeInformerGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	sw.Do(clusterInjectionFakeInformer, m)

	return sw.Error()
}

var clusterInjectionFakeInformer = `
