...
// clusterFakeFilteredFactoryGenerator produces a file of listers for a given GroupVersion and
// type.
type clusterFakeFilteredFactoryGenerator struct {
...
var _ generator.Generator = (*clusterFakeFilteredFactoryGenerator)(nil)

func (g *clusterFakeFilteredFactoryGenerator) Filter(c *generator.Context, t *types.Type) bool {
...
func (g *clusterFakeFilteredFactoryGenerator) Namers(c *generator.Context) namer.NameSystems {
	return namer.NameSystems{
		"raw": namer.NewRawNamer(g.outputPackage, g.imports),
	}
}

func (g *clusterFakeFilteredFactoryGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterFakeFilteredFactoryGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	sw.Do(clusterInjectionFakeFilteredInformerFactory, m)

	return sw.Error()
}

var clusterInjectionFakeFilteredInformerFactory = `
