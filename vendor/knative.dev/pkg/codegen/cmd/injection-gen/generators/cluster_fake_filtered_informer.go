...
// clusterFakeFilteredInformerGenerator produces a file of listers for a given GroupVersion and
// type.
type clusterFakeFilteredInformerGenerator struct {
...
var _ generator.Generator = (*clusterFakeFilteredInformerGenerator)(nil)

func (g *clusterFakeFilteredInformerGenerator) Filter(c *generator.Context, t *types.Type) bool {
	// Only process the type for this informer generator.
	return t == g.typeToGenerate
}

func (g *clusterFakeFilteredInformerGenerator) Namers(c *generator.Context) namer.NameSystems {
...
func (g *clusterFakeFilteredInformerGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterFakeFilteredInformerGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	sw.Do(clusterInjectionFakeFilteredInformer, m)

	return sw.Error()
}

var clusterInjectionFakeFilteredInformer = `
