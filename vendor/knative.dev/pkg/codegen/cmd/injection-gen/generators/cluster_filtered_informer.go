...
// type.
type clusterFilteredInjectionGenerator struct {
...
var _ generator.Generator = (*clusterFilteredInjectionGenerator)(nil)

func (g *clusterFilteredInjectionGenerator) Filter(c *generator.Context, t *types.Type) bool {
	// Only process the type for this informer generator.
	return t == g.typeToGenerate
}

func (g *clusterFilteredInjectionGenerator) Namers(c *generator.Context) namer.NameSystems {
...
func (g *clusterFilteredInjectionGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterFilteredInjectionGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"informersTypedInformer":             c.Universe.Type(types.Name{Package: g.typedInformerPackage, Name: t.Name.Name + "ClusterInformer"}),
	...
	sw.Do(clusterFilteredInjectionInformer, m)

	return sw.Error()
}

var clusterFilteredInjectionInformer = `
func init() {
