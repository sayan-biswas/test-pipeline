...
// clusterReconcilerStateGenerator produces a reconciler state object to manage reconciliation runs.
type clusterReconcilerStateGenerator struct {
...
var _ generator.Generator = (*clusterReconcilerStateGenerator)(nil)

func (g *clusterReconcilerStateGenerator) Filter(c *generator.Context, t *types.Type) bool {
	// Only process the type for this generator.
	return t == g.typeToGenerate
}

func (g *clusterReconcilerStateGenerator) Namers(c *generator.Context) namer.NameSystems {
	return namer.NameSystems{
		"raw": namer.NewRawNamer(g.outputPackage, g.imports),
	}
}

func (g *clusterReconcilerStateGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterReconcilerStateGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"cacheSplitMetaClusterNamespaceKey": c.Universe.Function(types.Name{
			Package: "github.com/kcp-dev/apimachinery/pkg/cache",
	...
	sw.Do(clusterReconcilerStateType, m)
	sw.Do(clusterReconcilerStateMethods, m)

	return sw.Error()
}

var clusterReconcilerStateType = `
...
type state struct {
	...
	cluster {{.logicalClusterName|raw}}
...
func newState(key string, r *reconcilerImpl) (*state, error) {
	...
	cluster, namespace, name, err := {{.cacheSplitMetaClusterNamespaceKey|raw}}(key)
	if err != nil {
...
var clusterReconcilerStateMethods = `
