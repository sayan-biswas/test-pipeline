...
// clusterClientGenerator produces a file of listers for a given GroupVersion and
// type.
type clusterClientGenerator struct {
...
var _ generator.Generator = (*clusterClientGenerator)(nil)

func (g *clusterClientGenerator) Filter(c *generator.Context, t *types.Type) bool {
...
func (g *clusterClientGenerator) Namers(c *generator.Context) namer.NameSystems {
...
func (g *clusterClientGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterClientGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"clientSetInterface":             c.Universe.Type(types.Name{Package: g.clientSetPackage, Name: "ClusterInterface"}),
	...
	sw.Do(clusterInjectionClient, m)

	return sw.Error()
}

var clusterInjectionClient = `
func init() {
