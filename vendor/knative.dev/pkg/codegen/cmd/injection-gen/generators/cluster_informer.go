...
// type.
type clusterInjectionGenerator struct {
...
var _ generator.Generator = (*clusterInjectionGenerator)(nil)

func (g *clusterInjectionGenerator) Filter(c *generator.Context, t *types.Type) bool {
	// Only process the type for this informer generator.
	return t == g.typeToGenerate
}

func (g *clusterInjectionGenerator) Namers(c *generator.Context) namer.NameSystems {
...
func (g *clusterInjectionGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterInjectionGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	sw.Do(clusterInjectionInformer, m)

	return sw.Error()
}

var clusterInjectionInformer = `
func init() {
