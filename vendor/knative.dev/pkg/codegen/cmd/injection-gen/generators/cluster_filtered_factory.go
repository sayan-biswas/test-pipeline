...
type clusterFilteredFactoryGenerator struct {
...
var _ generator.Generator = (*clusterFilteredFactoryGenerator)(nil)

func (g *clusterFilteredFactoryGenerator) Filter(c *generator.Context, t *types.Type) bool {
...
func (g *clusterFilteredFactoryGenerator) Namers(c *generator.Context) namer.NameSystems {
	return namer.NameSystems{
		"raw": namer.NewRawNamer(g.outputPackage, g.imports),
	}
}

func (g *clusterFilteredFactoryGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterFilteredFactoryGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	sw.Do(clusterInjectionFilteredFactory, m)

	return sw.Error()
}

var clusterInjectionFilteredFactory = `
func init() {
