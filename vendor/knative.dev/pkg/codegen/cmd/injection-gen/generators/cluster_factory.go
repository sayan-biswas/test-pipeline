...
type clusterFactoryGenerator struct {
...
var _ generator.Generator = (*clusterFactoryGenerator)(nil)

func (g *clusterFactoryGenerator) Filter(c *generator.Context, t *types.Type) bool {
...
func (g *clusterFactoryGenerator) Namers(c *generator.Context) namer.NameSystems {
	return namer.NameSystems{
		"raw": namer.NewRawNamer(g.outputPackage, g.imports),
	}
}

func (g *clusterFactoryGenerator) Imports(c *generator.Context) (imports []string) {
	imports = append(imports, g.imports.ImportLines()...)
	return
}

func (g *clusterFactoryGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	sw.Do(clusterInjectionFactory, m)

	return sw.Error()
}

var clusterInjectionFactory = `
func init() {
