...
func (c *TektonV1alpha1ClusterClient) PipelineResources() kcptektonv1alpha1.PipelineResourceClusterInterface {
	return &pipelineResourcesClusterClient{Fake: c.Fake}
}
...
func (c *TektonV1alpha1Client) PipelineResources(namespace string) tektonv1alpha1.PipelineResourceInterface {
	return &pipelineResourcesClient{Fake: c.Fake, Cluster: c.Cluster, Namespace: namespace}
}
