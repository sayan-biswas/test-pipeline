...
import (
	...
	tektoninformers "github.com/tektoncd/pipeline/pkg/client/resource/cluster/informers/tekton"
...
type SharedInformerFactory interface {
	...
	Tekton() tektoninformers.ClusterInterface
}


func (f *sharedInformerFactory) Tekton() tektoninformers.ClusterInterface {
  return tektoninformers.New(f, f.tweakListOptions)
}
