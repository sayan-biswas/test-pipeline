...
import (
	...
	resolutionv1alpha1 "github.com/tektoncd/pipeline/pkg/client/resolution/cluster/clientset/typed/resolution/v1alpha1"
	resolutionv1beta1 "github.com/tektoncd/pipeline/pkg/client/resolution/cluster/clientset/typed/resolution/v1beta1"
)

type ClusterInterface interface {
	Cluster(logicalcluster.Name) client.Interface
	Discovery() discovery.DiscoveryInterface
	ResolutionV1alpha1() resolutionv1alpha1.ResolutionV1alpha1ClusterInterface
	ResolutionV1beta1() resolutionv1beta1.ResolutionV1beta1ClusterInterface
}
...
type ClusterClientset struct {
	*discovery.DiscoveryClient
	...
	resolutionV1alpha1 *resolutionv1alpha1.ResolutionV1alpha1ClusterClient
	resolutionV1beta1 *resolutionv1beta1.ResolutionV1beta1ClusterClient
}
...
func (c *ClusterClientset) ResolutionV1alpha1() resolutionv1alpha1.ResolutionV1alpha1ClusterInterface {
	return c.resolutionV1alpha1
}

// ResolutionV1beta1 retrieves the ResolutionV1beta1ClusterClient.  
func (c *ClusterClientset) ResolutionV1beta1() resolutionv1beta1.ResolutionV1beta1ClusterInterface {
