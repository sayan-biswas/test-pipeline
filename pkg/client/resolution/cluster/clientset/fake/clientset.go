...
import (
	...
	client "github.com/tektoncd/pipeline/pkg/client/resolution/clientset/versioned"
	clientscheme "github.com/tektoncd/pipeline/pkg/client/resolution/clientset/versioned/scheme"

	kcpclient "github.com/tektoncd/pipeline/pkg/client/resolution/cluster/clientset"
	...
	fakeresolutionv1alpha1 "github.com/tektoncd/pipeline/pkg/client/resolution/cluster/clientset/typed/resolution/v1alpha1/fake"
	fakeresolutionv1beta1 "github.com/tektoncd/pipeline/pkg/client/resolution/cluster/clientset/typed/resolution/v1beta1/fake"
)
...
// ResolutionV1alpha1 retrieves the ResolutionV1alpha1ClusterClient.  
func (c *ClusterClientset) ResolutionV1alpha1() kcpresolutionv1alpha1.ResolutionV1alpha1ClusterInterface {
	return &fakeresolutionv1alpha1.ResolutionV1alpha1ClusterClient{Fake: c.Fake}
}

// ResolutionV1beta1 retrieves the ResolutionV1beta1ClusterClient.  
func (c *ClusterClientset) ResolutionV1beta1() kcpresolutionv1beta1.ResolutionV1beta1ClusterInterface {
	return &fakeresolutionv1beta1.ResolutionV1beta1ClusterClient{Fake: c.Fake}
}
...
func (c *Clientset) ResolutionV1alpha1() resolutionv1alpha1.ResolutionV1alpha1Interface {
	return &fakeresolutionv1alpha1.ResolutionV1alpha1Client{Fake: c.Fake, Cluster: c.cluster}
}
...
func (c *Clientset) ResolutionV1beta1() resolutionv1beta1.ResolutionV1beta1Interface {
	return &fakeresolutionv1beta1.ResolutionV1beta1Client{Fake: c.Fake, Cluster: c.cluster}
}
