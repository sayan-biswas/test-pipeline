...
import (
	...
	resolutioninformers "github.com/tektoncd/pipeline/pkg/client/resolution/cluster/informers/resolution"
...
type SharedInformerFactory interface {
	...
	Resolution() resolutioninformers.ClusterInterface
}


func (f *sharedInformerFactory) Resolution() resolutioninformers.ClusterInterface {
  return resolutioninformers.New(f, f.tweakListOptions)
}
