...
import (
	...
	upstreaminformers "github.com/tektoncd/pipeline/pkg/client/resolution/informers/externalversions"
...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericClusterInformer, error) {
	...
	case resolutionv1alpha1.SchemeGroupVersion.WithResource("resolutionrequests"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Resolution().V1alpha1().ResolutionRequests().Informer()}, nil
	// Group=resolution.tekton.dev, Version=V1beta1
	case resolutionv1beta1.SchemeGroupVersion.WithResource("resolutionrequests"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Resolution().V1beta1().ResolutionRequests().Informer()}, nil
}
