...
import (
	...
	tektonv1 "github.com/tektoncd/pipeline/pkg/client/cluster/clientset/typed/tekton/v1"
	tektonv1alpha1 "github.com/tektoncd/pipeline/pkg/client/cluster/clientset/typed/tekton/v1alpha1"
	tektonv1beta1 "github.com/tektoncd/pipeline/pkg/client/cluster/clientset/typed/tekton/v1beta1"
)

type ClusterInterface interface {
	Cluster(logicalcluster.Name) client.Interface
	Discovery() discovery.DiscoveryInterface
	TektonV1() tektonv1.TektonV1ClusterInterface
	TektonV1alpha1() tektonv1alpha1.TektonV1alpha1ClusterInterface
	TektonV1beta1() tektonv1beta1.TektonV1beta1ClusterInterface
}
...
type ClusterClientset struct {
	*discovery.DiscoveryClient
	...
	tektonV1 *tektonv1.TektonV1ClusterClient
	tektonV1alpha1 *tektonv1alpha1.TektonV1alpha1ClusterClient
	tektonV1beta1 *tektonv1beta1.TektonV1beta1ClusterClient
}
...
func (c *ClusterClientset) TektonV1() tektonv1.TektonV1ClusterInterface {
	return c.tektonV1
}

// TektonV1alpha1 retrieves the TektonV1alpha1ClusterClient.  
func (c *ClusterClientset) TektonV1alpha1() tektonv1alpha1.TektonV1alpha1ClusterInterface {
	return c.tektonV1alpha1
}

// TektonV1beta1 retrieves the TektonV1beta1ClusterClient.  
func (c *ClusterClientset) TektonV1beta1() tektonv1beta1.TektonV1beta1ClusterInterface {
