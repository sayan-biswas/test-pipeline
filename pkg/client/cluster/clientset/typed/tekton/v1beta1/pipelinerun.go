...
type PipelineRunClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*tektonv1beta1.PipelineRunList, error)
...
func (c *pipelineRunsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*tektonv1beta1.PipelineRunList, error) {
...
// PipelineRunsNamespacer can scope to objects within a namespace, returning a tektonv1beta1client.PipelineRunInterface.
type PipelineRunsNamespacer interface {
	Namespace(string) tektonv1beta1client.PipelineRunInterface
}
