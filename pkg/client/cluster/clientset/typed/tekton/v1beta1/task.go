...
type TaskClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*tektonv1beta1.TaskList, error)
...
func (c *tasksClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*tektonv1beta1.TaskList, error) {
...
// TasksNamespacer can scope to objects within a namespace, returning a tektonv1beta1client.TaskInterface.
type TasksNamespacer interface {
	Namespace(string) tektonv1beta1client.TaskInterface
}
