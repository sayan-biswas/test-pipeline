...
import (
	...
	client "github.com/tektoncd/pipeline/pkg/client/clientset/versioned"
	clientscheme "github.com/tektoncd/pipeline/pkg/client/clientset/versioned/scheme"

	kcpclient "github.com/tektoncd/pipeline/pkg/client/cluster/clientset"
	...
	faketektonv1 "github.com/tektoncd/pipeline/pkg/client/cluster/clientset/typed/tekton/v1/fake"
	faketektonv1alpha1 "github.com/tektoncd/pipeline/pkg/client/cluster/clientset/typed/tekton/v1alpha1/fake"
	faketektonv1beta1 "github.com/tektoncd/pipeline/pkg/client/cluster/clientset/typed/tekton/v1beta1/fake"
)
...
// TektonV1 retrieves the TektonV1ClusterClient.  
func (c *ClusterClientset) TektonV1() kcptektonv1.TektonV1ClusterInterface {
	return &faketektonv1.TektonV1ClusterClient{Fake: c.Fake}
}

// TektonV1alpha1 retrieves the TektonV1alpha1ClusterClient.  
func (c *ClusterClientset) TektonV1alpha1() kcptektonv1alpha1.TektonV1alpha1ClusterInterface {
	return &faketektonv1alpha1.TektonV1alpha1ClusterClient{Fake: c.Fake}
}

// TektonV1beta1 retrieves the TektonV1beta1ClusterClient.  
func (c *ClusterClientset) TektonV1beta1() kcptektonv1beta1.TektonV1beta1ClusterInterface {
	return &faketektonv1beta1.TektonV1beta1ClusterClient{Fake: c.Fake}
}
