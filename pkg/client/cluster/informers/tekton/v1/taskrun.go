...
type TaskRunClusterInformer interface {
	Cluster(logicalcluster.Name) upstreamtektonv1informers.TaskRunInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() tektonv1listers.TaskRunClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TektonV1().TaskRuns().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TektonV1().TaskRuns().Watch(context.TODO(), options)
			},
		},
		&tektonv1.TaskRun{},
		resyncPeriod,
...
func (f *taskRunClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&tektonv1.TaskRun{}, f.defaultInformer)
}

func (f *taskRunClusterInformer) Lister() tektonv1listers.TaskRunClusterLister {
	return tektonv1listers.NewTaskRunClusterLister(f.Informer().GetIndexer())
}

func (f *taskRunClusterInformer) Cluster(cluster logicalcluster.Name) upstreamtektonv1informers.TaskRunInformer {
...
type taskRunInformer struct {
	...
	lister upstreamtektonv1listers.TaskRunLister
}
...
func (f *taskRunInformer) Lister() upstreamtektonv1listers.TaskRunLister {
	return f.lister
}
