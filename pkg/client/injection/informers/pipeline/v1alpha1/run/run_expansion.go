...
import (
	...
	v1alpha1 "github.com/tektoncd/pipeline/pkg/client/cluster/informers/tekton/v1alpha1"
...
func GetCluster(ctx context.Context) v1alpha1.RunClusterInformer {
	...
	return untyped.(v1alpha1.RunClusterInformer)
}